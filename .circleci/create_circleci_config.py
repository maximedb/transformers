...
class CircleCIJob:
    ...
    def to_dict(self):
        ...
        test_command = 'TEST=$(echo "tests/models/bert/test_modeliing_bert.py tests/models/gpt2/test_modeliing_gpt2.py" | circleci tests split --split-by=timings) && python -m pytest -n 3 --max-worker-restart=0 --dist=loadfile -s --make-reports=tests_$TEST  | tee tests_output.txt'
